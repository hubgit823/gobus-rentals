...
export const homeSeoArticleSections: readonly {
  ...
  {
    id: "keywords-routes",
    title: "Bus Hire Keywords, City Coverage & Route Planning for North India",
    paragraphs: [
